...
> ## 🟡 Status: in progress; Tasks 1–4 done, listening round 1 signed off (2026-09-24)
>
> The design was locked in the 2026-09-23 interview. This plan and all nine planning decisions
> were approved on 2026-09-24. All work is on the **`audio` branch**. **Next: Task 5.**
>
> The 29 sound effects are rendered, measured, and signed off by ear, but nothing plays in the
> game yet. Read **Deviations** before Tasks 5–6: several notes there are instructions for them.
> That includes the deal's riffle, `SfxChoice.flip(card)`, which Task 5 must feed.
>
