...
> ## 🟡 Status: in progress; Tasks 1–6 done, Task 7 next (2026-09-24)
>
...
> in-game sound log, and all three listening rounds are signed off. **Next: Task 7, the
> controls.** Plan it and get the user's approval before coding.
>
